...
class ItemBuilder<C extends ItemCubit<S>, S extends ItemState>
  ...
  void _onInit(BuildContext context) =>
      onInit != null ? onInit?.call(context) : _cubitInstance(context).load();
  ...
  Widget build(BuildContext context) {
    ...
    return StatefullBuilder(
      ...
      builder: (context) => BlocConsumer<C, S>(
